...
class WalletBleCommunicator(context: Context, private val eventEmitter: IEventEmitter, private val handleException: (BLEException) -> Unit) : ICentralListener, ITransferListener {
