package io.mosip.ble.central

import android.bluetooth.BluetoothDevice
import android.content.Context
import android.os.HandlerThread
import android.os.Process
import io.mosip.ble.central.impl.Controller
import io.mosip.ble.central.state.IMessageSender
import io.mosip.ble.central.state.StateHandler
import io.mosip.ble.central.state.message.*
import java.util.*
